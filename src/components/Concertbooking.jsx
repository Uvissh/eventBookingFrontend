...
import Cancelconcert from "./Cancelconcert";
function Concertbooking({seat,status,show,onClose}){
    const [loading, setLoading] = useState(false);
      ...
      const handleBooking = async () => {
        try {
          ...
          const response = await api.post("/concertbooking",
            {
              seat_id: seat.id,
            },
          ...
          console.log("this is concertbooking",response.data.concertBooking.id);
    
          setBooking(response.data.concertBooking);
